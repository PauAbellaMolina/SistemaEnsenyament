    ...
    <div class="card mb-1">
        <div id="elementCards" class="card-body d-flex flex-row">
            ...
            <div class="w-100 d-flex justify-content-between">
                <p class="ml-4">
                    <a class="customLink" title="Editar" :href="'/SistemaEnsenyament/categorias/edit/'+categoria.id">
                ...
                <p v-else class="mr-3">
                    <a class="customLink borrar" title="Borrar" :href="'/SistemaEnsenyament/categorias/delete/'+categoria.id">
